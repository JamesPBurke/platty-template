function moveToTile (aSprite: Sprite, x: number, y: number) {
    aSprite.setPosition(x * 16 + 8, y * 16 + 8)
}
tiles.setCurrentTilemap(tilemap`level1`)
let platty = sprites.create(img`
    . . . . . . . . . . b e b . . . 
    . . . . . . . . . b e b . . . . 
    . . . . . . b b b b b b . . . . 
    . . . . . b b e e e e e b . . . 
    . . . . b b e d 1 f e d 6 c . . 
    . . . . b e e 1 f f d d 6 6 6 b 
    . . . . b e e d f b 6 6 6 6 b . 
    . . . b e e e e e 6 6 6 6 b . . 
    . . b e e e e e e e e e e b . . 
    . b e e e e e e e e e e e e b . 
    b e e e b b b e e e e e e e b . 
    c e e b e e e c e e e e e e b . 
    c b b e e e c e e e e e e e b . 
    . b e e b c e e e e e e e d b . 
    b b c c c e e e e e e e b b . . 
    . . . c c c c c c c c b b . . . 
    `, SpriteKind.Player)
let taco = sprites.create(img`
    ...
    ................................
    `, SpriteKind.Food)
scene.cameraFollowSprite(platty)
controller.moveSprite(platty)
moveToTile(platty, 7, 98)
moveToTile(taco, 7, 1)
